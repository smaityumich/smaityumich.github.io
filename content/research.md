...
<u>**Transfer learning:**</u> Transfer learning improves prediction and inference in data-scarce target domains by borrowing information from related source domains. It has emerged as a central topic in machine learning and statistics over the past decade. My research focuses on the development and theoretical understanding of transfer learning models and methods for a variety of statistical tasks. Selected examples of this work are listed below.
...
- Mengqi Xu, PhD Student (joint supervision with [Prof. Joel Dubin](https://uwaterloo.ca/health-data-science-lab/contacts/joel-dubin))
- Manli Chen, Postdoctoral Fellow (joint supervision with [Prof. Qinglong Tian](https://sites.google.com/view/qltian/bio) and [Prof. Pengfei Li](https://sas.uwaterloo.ca/~p4li/))
